...
# Video path
cap = cv2.VideoCapture('C:\\Users\\tirza\\Desktop\\SUSPICIOUS ACTIVITY DETECTION\\yolo11_suspicious_activity-main\\normal.mp4')
...
while cap.isOpened():
    ...
    pa = r'C:\\Users\\tirza\\Desktop\\SUSPICIOUS ACTIVITY DETECTION\\yolo11_suspicious_activity-main\\images'
    ...
    for r in results:
        ...
        for index, box in enumerate(bound_box):
            if conf[index] > 0.75:
                ...
                op = r'C:\\Users\\tirza\\Desktop\\SUSPICIOUS ACTIVITY DETECTION\\yolo11_suspicious_activity-main\\images 1'
