...
df = pd.read_csv(r'D:\SUSPICIOUS ACTIVITY DETECTION\yolo11_suspicious_activity-main\keypoint.csv')

dataset_path = r'D:\SUSPICIOUS ACTIVITY DETECTION\yolo11_suspicious_activity-main\dataset_path'
