...
df = pd.read_csv(r'D:\SUSPICIOUS ACTIVITY DETECTION\yolo11_suspicious_activity-main\dataset_path\dataset_path.csv')
...
model.save_model(r"D:\SUSPICIOUS ACTIVITY DETECTION\yolo11_suspicious_activity-main\trained_model.json")
